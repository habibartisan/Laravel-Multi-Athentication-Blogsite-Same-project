                    ...
                    <div class="main-post">
                        ...
                        <div class="blog-post-inner">
                            ...
                            <div class="post-info">
                                ...
                                <div class="left-area">
                                    <a class="avatar" href="#"><img src="{{asset('storage')}}/{{$post->user->image}}" height="50px" width="50px" alt="Profile Image"></a>
                                </div>
                ...
                <div class="col-lg-4 col-md-12 no-left-padding">
                    ...
                    <div class="single-post info-area">
                        ...
                        <div class="tag-area">
                            ...
                            <h4 class="title"><b>CATAGORIS</b></h4>
                            <ul>

                               @foreach($post->categories as $categorie)
                                    <li><a href="{{route('post.details',$post->slug)}}">{{$categorie->name}}</a></li>
                                @endforeach
                            </ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100">
                        <div class="single-post post-style-1">
                            ...
                            <div class="blog-image"><img height="220px" width="60px" src="{{asset('storage')}}/{{$randompost->image}}"></div>

                            <a class="avatar" href="#"><img height="60px" width="60px" src="{{asset('storage')}}/{{$randompost->image}}" alt="Profile Image"></a>
